  ...
  return (
    <Form onSubmit={register}>
      ...
      <Input
        ...
        value={category}
      />
      <Input type="number" placeholder="Preço" required onChange={(ev) => setPrice(ev.target.value)} value={price} />
      <Input type="text" placeholder="Imagem" required onChange={(ev) => setImage(ev.target.value)} value={image} />
      <Input
        type="text"
